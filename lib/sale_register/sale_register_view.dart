...
FutureOr<Uint8List> saleRegisterGroupView(
  SaleRegisterInput data,
) {
...
FutureOr<Uint8List> saleRegisterGroupViewDetailMode(
  SaleRegisterInput data,
) {
  final pdf = pw.Document(version: PdfVersion.pdf_1_5, compress: true);
  final font = pw.Font.courier();
              ...
              for (final record in data.records)
                pw.TableRow(
                  children: [
                    ...
                    buildTableCell(
                      value: record.eftAmount.toStringAsFixed(2),
                      alignment: pw.Alignment.centerRight,
                    ),
                    buildTableCell(
                      value: record.amount.toStringAsFixed(2),
